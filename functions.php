...
function theme_setup() {
    ...
    register_nav_menus(array(
        'header-menu' => __('Header Menu', 'jaakkoheikkila'), 
    ));
    ...
    // Fix post thumbnail missing on custom post types
...
function theme_scripts_styles() {
    ...
    wp_enqueue_style('swiper', 'https://cdn.jsdelivr.net/npm/swiper@8.4.7/swiper-bundle.min.css', array(), '8.4.7');
...
{   
    ...
    register_sidebar(array(
        'name' => __('Footer 1', 'jaakkoheikkila'),
        'description' => __('Widget area in footer', 'jaakkoheikkila'),
        'id' => 'sidebar-footer',
...
function add_img_column($columns) {
    $columns['img'] = __('Image', 'jaakkoheikkila');
    return $columns;
}
